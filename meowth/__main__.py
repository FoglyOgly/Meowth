...
async def want(ctx):
    ...
    if role in ctx.message.author.roles:
        ...
        want_img_url = "https://raw.githubusercontent.com/FoglyOgly/Meowth/master/pokegifs/{}.gif".format(entered_want) #This part embeds the sprite
...
async def _wild(message):
    ...
    if entered_wild not in pkmn_info['pokemon_list']:
        ...
        wild_img_url = "https://raw.githubusercontent.com/FoglyOgly/Meowth/master/pokegifs/{}.gif".format(entered_wild)
...
async def _raid(message):
    ...
    raid_img_url = "https://raw.githubusercontent.com/FoglyOgly/Meowth/master/pokegifs/{}.gif".format(entered_raid)
