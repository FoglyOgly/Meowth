...
async def announce(ctx, *, announce=None):
    ...
    if reaction:
        ...
        if reaction.emoji == '❎':
            ...
            await draft.delete()
        elif (reaction.emoji == '🌎') and checks.is_owner_check(ctx):
            failed = 0
            sent = 0
            count = 0
            recipients = {
