...
class SilphCard:
    ...
    __slots__ = ('id', 'home_region', 'team', 'title', 'playstyle', 'level',
                 'avatar_url', 'silph_username', 'game_username', 'url',
    ...
    def __init__(self, silph_username, data):
        ...
        self.silph_username = silph_username
        self.game_username = data.get('in_game_username')
    ...
    def embed(self, utc_offset=None):
        ...
        if not self.discord_username:
            ...
            connected_str = (
                f"\u2611 **Connected to Discord:** {self.discord_username}")
        ...
        embed.set_author(
            name=(
                f"{self.title} {self.game_username} - "
...
class Silph:
    ...
    # async def silph(self, ctx):
    #     return

    # @silph.command()
    # async def card(self, ctx, silph_user):
